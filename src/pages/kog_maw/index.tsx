  ...
  return (
    <div className={styles.container}>
      <ChampionInfo
        ...
        passive='/images/KogMaw_IcathianSurprise.png'
        passivealt="Kog'Maw Icathian Surprise"
        passiveheight={50} passivewidth={50}
        passivetitle="Icathian Surprise"
        passivedescription='4 seconds after dying, Kogmaw explodes, dealing true damage to surrounding enemies.'
        skill1='/images/KogMawQ.png'
        skillalt1="Kog'Maw Caustic Spittle"
        skillheight1={50}
        skillwidth1={50}
        skilltitle1="Caustic Spittle"
        skilldescription1="Kog'Maw launches a corrosive projectile which deals magic damage and corrodes the target's armor and magic resist for a short time. Kog'Maw also gains additional attack speed."
        skill2='/images/KogMawBioArcaneBarrage.png'
        skillalt2="Kog'Maw Bio Arcane Barrage"
        skillheight2={50}
        skillwidth2={50}
        skilltitle2='Bio Arcane Barrage'
        skilldescription2="Kog'Maw's attacks gain range and deal a percent of the target's maximum health as magic damage."
        skill3='/images/KogMawVoidOoze.png'
        skillalt3="Void Ooze"
        skillheight3={50}
        skillwidth3={50}
        skilltitle3='Void Ooze'
        skilldescription3="Kog'Maw launches a peculiar ooze which damages all enemies it passes through and leaves a trail which slows enemies who stand on it."
        skill4='/images/KogMawLivingArtillery.png'
        skillalt4="Living Artillery"
        skillwidth4={50}
        skillheight4={50}
        skilltitle4="Living Artillery"
        skilldescription4="Kog'Maw fires an artillery shell at a great distance dealing magic damage (increased significantly on low health enemies) and revealing non-stealthed targets. Additionally, multiple Living Artilleries in a short period of time cause them to cost additional Mana." />
